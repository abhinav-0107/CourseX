## Create a course selling website Version 1

Only backend made using express.js is avaliable right now.
Admin and User authentication is done by sending the credentials in 'authorization' header.
...
Note -> Same person can signup as an admin as well as user.
