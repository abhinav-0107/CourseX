...
### Description
Functionally same as Version 2. I have added some new routes though.
Now the data gets stored in files vs in memory. Created separate files for each entity (ADMIN, USER, COURSE).
